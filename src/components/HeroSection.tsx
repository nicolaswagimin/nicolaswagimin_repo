      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Right Content - Simple Image Box */}
                ...
                <div className="w-full aspect-square bg-muted rounded-2xl border-2 border-border overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10">
                    <div className="text-center p-8">
                      <svg 
                        className="w-24 h-24 mx-auto mb-4 text-primary/30 dark:text-primary/40" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                  ...
                  {/* Para agregar tu imagen, descomenta esto y agrega tu imagen en /public:
                  <Image
                    src="/tu-imagen.jpg"
                    alt="Profile"
                    fill
                    ...
                    priority
                  />
                  No olvides importar: import Image from "next/image";
                  */}
                </div>
              </div>
            </div>
